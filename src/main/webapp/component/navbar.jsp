      ...
      <div class="col-12">
        ...
        <!-- Menubar -->
          ...
          <div class="navbar-nav" >
              <a id="menu_bg" class="nav-link" href="./home.jsp" style="color: white; padding-left: 20px; font-size: 15px;">Home </a>

              <a id="menu_bg" class="nav-link" href="./courses.jsp" style="color: white; padding-left: 20px;" >Courses</a>
              <a id="menu_bg" class="nav-link" href="./videos.jsp" style="color: white; padding-left: 20px;">Videos</a>      
              
              <a id="menu_bg"class="nav-link" href="./aboutus.jsp" style="color: white; padding-left: 20px;" >About Us</a>
              <a id="menu_bg" class="nav-link" href="./contactus.jsp" style="color: white; padding-left: 20px;">Contact Us</a>
              <a id="menu_bg" class="nav-link" href="./chatbot.jsp" style="color: white; padding-left: 20px;">TechStreet Assistant</a>
              <a id="menu_bg" class="nav-link" href="./logout.jsp" style="color: white; padding-left: 20px;">Logout</a>
              <a id="menu_bg" class="nav-link" href="./profile.jsp" style="color: white; padding-left: 20px;">Profile</a> 
              <a id="menu_bg" class="nav-link" href="./updatestudent.jsp" style="color: white; padding-left: 20px;">UpdateStudent</a>
