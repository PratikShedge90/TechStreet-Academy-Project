...
<%@ include file="../component/navbar.jsp" %>
    ...
    <div class="container-fluid pt-5 pb-3  all-page-heading-banner">
        <div class="container text-center">
            <h4 class="every-page-heading">About TechStreet Academy</h4>
            <p class="every-page-subheading">"We are an Educational & Development company committed in Building Future Enterprise. "</p>
        </div>
    </div>
    
    <div class="container-fluid p-5 common-div-bg">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3 col-12">
                    <img src="../img/aboutimg1.png" width="300" />
                </div>
                <div class="col-lg-9 col-12">
                    <h5> About TechStreet Academy </h5>
                    <p>
                        TechStreet Academy is a forward-thinking educational and development organization dedicated to empowering the next generation of enterprises. As a global leader in Information Technology, we help clients enhance their business operations by leveraging our vast industry knowledge, deep technical expertise, and comprehensive suite of services. Our vertically integrated approach enables us to align solutions with industry-specific needs effectively.
                    </p>
                    <p>
                        At TechStreet Academy, our "Centers of Excellence" in emerging technologies allow us to harness the latest advancements to deliver impactful, business-driven solutions for our clients. We are recognized for our innovative approach to creating business value and our commitment to sustainable practices. 
                    </p>
                    <p>
                        We specialize in overcoming the challenges of offshore collaboration, ensuring high-quality application delivery while meeting critical time-to-market demands. Trusted by global businesses, TechStreet Academy helps organizations innovate at the front lines while standardizing core operations through strategic technology interventions.

                        Our Global Delivery Model draws from a vast talent pool across the world to provide tailored solutions. By integrating our products and services, we enable businesses to leverage technology for transformative growth, ensuring alignment with today’s dynamic digital business landscape.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid p-5 common-div-bg">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-12">
                    <img src="../img/aboutus2.png" width="200" />
                </div>
            </div>
        </div>
    </div>

    <div class="container-fluid common-div-bg">
    ...
    <div class="container-fluid mt-5">
        <div class="container">
            <h5 class="text-center">Our Core Values</h5>
        <div class="row mt-4">
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="wcu-training-card">
                    <h6>Being Innovative</h6>
                    <p class="wcu-training-card-body">
